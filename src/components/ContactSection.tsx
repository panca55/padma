    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16" data-aos="fade-up">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">{t('contactUsTitle')}</h2>
            <div className="w-20 h-1 bg-blue-600 mx-auto mb-4"></div>
            <p className="text-gray-600 dark:text-gray-400">{t('letsGrow')}</p>
          </div>

          <div className="grid md:grid-cols-2 gap-12" data-aos="fade-up" data-aos-delay="200">
              {/* Contact Information */}
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">{t('headOffice')}</h3>
                ...
                <div className="pt-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">{t('otherOffices')}</h4>
              ...
              <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 p-8 rounded-xl shadow-2xl" data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-gray-700 dark:text-gray-300 mb-2 font-medium">{t('name')}</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-gray-700 dark:text-gray-300 mb-2 font-medium">{t('message')}</label>
                    <textarea
                      rows={4}
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-600 outline-none"
